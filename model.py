...
#         if cards[i] == 'A' and hand(cards) < 12:
#             return True
#     return False
                                                        ...
                                                        if valueOfHand >= 17:
                                                            ...
                                                            for kk in range(10):
                                                                ...
                                                                if valueOfHand >= 17:
                                                                    ...
                                                                    remaining += 1
                                                                    continue
    # print(dealerOutcomes)
    # print("Remaining: " + str(remaining))
    # print("Probs: " + str(dealerProbabilities))
    # print("Total: " + str(round(sum(dealerProbabilities), 3)))
...
def hitWinOdds(dealerOdds, playerCards, s):
    ...
    expectedEarnings = totalWin - totalLoss

    # print("Stand: " + str(currentWinOdds))
    # print("Hit: " + str([totalWin, totalTie, totalLoss]))
    if expectedEarnings > initalExpectedEarnings:
        if totalWin > 0.5 and len(playerCards) < 3:
            return 'D'
        else:
            return 'H'
    else:
